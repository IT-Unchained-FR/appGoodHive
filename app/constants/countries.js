export const countries = [
  ...
  { value: "BQ", label: "Bonaire, Sint Eustatius and Saba", phoneCode: "+599" },
  { value: "BA", label: "Bosnia and Herzegovina", phoneCode: "+387" },
  { value: "BW", label: "Botswana", phoneCode: "+267" },
  { value: "BV", label: "Bouvet Island", phoneCode: "+55" },
  ...
  { value: "DO", label: "Dominican Republic", phoneCode: "+1-809, +1-829, +1-849" },
  ...
  { value: "HM", label: "Heard Island and McDonald Islands", phoneCode: "+672" },
  { value: "VA", label: "Holy See", phoneCode: "+39" },
  ...
  { value: "PR", label: "Puerto Rico", phoneCode: "+1-787, +1-939" },
  ...
  { value: "SH", label: "Saint Helena, Ascension and Tristan da Cunha", phoneCode: "+290" },
  ...
  { value: "GS", label: "South Georgia and the South Sandwich Islands", phoneCode: "+500" },
  ...
  { value: "GB", label: "United Kingdom of Great Britain and Northern Ireland", phoneCode: "+44" },
  ...
  { value: "VE", label: "Venezuela (Bolivarian Republic of)", phoneCode: "+58" },
