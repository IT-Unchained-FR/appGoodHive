    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="flex gap-2">
          ...
          <Link
            href={`/companies/dashboard/hiring-coach?jobId=${jobId}&applicationId=${application.id}`}
            className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-amber-700 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors"
          >
