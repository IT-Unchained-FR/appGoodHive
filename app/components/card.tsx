      ...
      <div className="p-4 flex flex-col h-full">
        ...
        <div className="mb-3">
          ...
          {type === "talent" && showRate && (
            <div className="mt-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-[10px] font-medium text-emerald-700 shadow-sm">
