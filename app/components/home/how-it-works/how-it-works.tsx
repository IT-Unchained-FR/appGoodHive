...
export const HowItWorks = () => {
  ...
  return (
    <div className="container mx-auto w-full pt-12 pb-12 flex flex-col items-center sm:pt-5">
      <h1 className="text-black text-center text-3xl font-bold mb-6 sm:text-2xl">{TRANSLATION.title}</h1>
      <p className="text-black text-center text-lg font-normal mb-16 sm:text-base sm:mb-8">{TRANSLATION.description}</p>
      <div className="mb-12">
        <iframe
