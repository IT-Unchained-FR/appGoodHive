  ...
  return (
    <div>
      ...
      <p>
        ...
        collaborating with the brightest minds in IT starts now. We&apos;re thrilled
        to have {name} join our community that&apos;s reshaping the Future of Work
        with values like excellence, commitment, service, and openness.
      </p>
      <p>
        Here&apos;s the first step: To ensure your profile is spot-on and aligns with
        your hiring needs, let&apos;s have a chat! Please schedule a 45-minute
        meeting with us at{" "}
      ...
      <p>
        We&apos;re looking forward to our conversation and to supporting {name} in
        navigating this exciting landscape of IT talents. Let&apos;s create amazing
