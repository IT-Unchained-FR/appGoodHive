      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300">
        ...
        <div className="overflow-y-auto flex-1 px-6 py-5 space-y-5">
          ...
          <div className="flex items-center gap-3 p-3 rounded-2xl bg-slate-50 border border-slate-100">
            <Avatar src={entry.talent_image} name={entry.talent_name} size="md" />
          ...
          <div className="space-y-3">
            ...
            <label className="flex items-center gap-2.5 cursor-pointer select-none">
              ...
              >
                <div className={`w-4 h-4 rounded-full bg-white shadow-sm mt-0.5 transition-transform ${anonymize ? "translate-x-4.5" : "translate-x-0.5"}`} />
              </div>
              <div>
...
function KanbanColumn({
  stage, entries, onDelete, onMove, collapsed, onToggleCollapse, selectedIds, onToggleSelect, onSendToClient,
}: {
