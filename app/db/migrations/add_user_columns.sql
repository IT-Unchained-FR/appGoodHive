...
ADD COLUMN IF NOT EXISTS okto_id VARCHAR(255) UNIQUE,
...
-- Create index on okto_id for faster lookups
CREATE INDEX IF NOT EXISTS idx_users_okto_id ON goodhive.users(okto_id);
